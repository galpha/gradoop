...
public class LongIdTupleToGellyEdgeWithNullValueJoin implements
  JoinFunction<Tuple3<Long, Long, GradoopId>, Tuple2<Long, GradoopId>, Edge<Long, NullValue>> {
  ...
  /**
   * Creates an instance of LongIdTupleToGellyEdgeWithNullValueJoin.
   */
  public LongIdTupleToGellyEdgeWithNullValueJoin() {
    this.reuseEdge = new Edge<>();
  }

  @Override
  public Edge<Long, NullValue> join(Tuple3<Long, Long, GradoopId> edgeTuple,
