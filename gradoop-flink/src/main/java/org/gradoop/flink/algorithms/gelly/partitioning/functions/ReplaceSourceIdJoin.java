...
public class ReplaceSourceIdJoin implements
  JoinFunction<Edge, Tuple3<Long, GradoopId, Long>, Tuple3<Long, GradoopId, GradoopId>> {
  ...
  public Tuple3<Long, GradoopId, GradoopId> join(
    Edge epgmEdge,
    Tuple3<Long, GradoopId, Long> uniqueLongToVertexId) throws Exception {
